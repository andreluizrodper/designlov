<?php
 ...
 ?>
 	<div class="section-utils">
 		<h2 class="title-section">Resultado da busca</h2>
	 	<p class="text-section">
	 		Yay! encontramos <strong><?php global $wp_query; echo $wp_query->found_posts; ?> resultados</strong> para o termo buscado
	 	</p>
 	</div>
	<ul class="grid">
	<?php
